...
class DpdWord:
    def __init__(self, df: DataFrame, row: int):
        ...
        self.sbs_pali_chant: str = df.loc[row, "SBS Pali chant name"]
        self.sbs_eng_chant: str = df.loc[row, "SBS English chant name"]
        self.chapter: str = df.loc[row, "SBS Chapter"]
        self.sbs_index: str = df.loc[row, "SBS index"]
